...
enum {
	...
	/// Public file format constant:  'AVIF', AVIF file format
	kXMP_AVIFFile = 0x41564946UL,
...
enum {
	...
	///In PNG use eXIf chunk for exif read and write
	kXMPFiles_PngUseExifChunk    =  0x00000800
};
