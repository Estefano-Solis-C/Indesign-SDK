...
#define XMPCORE_API_VERSION_MAJOR  9
#define XMPCORE_API_VERSION_MINOR  1

#define XMPFILES_API_VERSION_MAJOR  9
#define XMPFILES_API_VERSION_MINOR  3

#define XMPSCRIPT_API_VERSION_MAJOR  8
#define XMPSCRIPT_API_VERSION_MINOR  0

#define XMPCOMPAREANDMERGE_API_VERSION_MAJOR	5
