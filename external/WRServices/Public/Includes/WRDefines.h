...
typedef enum {
	kWRLeftToRight,
	kWRTopToBottom
}WritingDirection;//in future can be updated to include kWRRightToLeft and kWRBottomToTop. Currently RTL is handled via fMainDir flag 
...
enum {
	...
	kWRdirLRE,					/* Left-to-Right Embedding, 		Strong 	*/ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
	kWRdirLRO,					/* Left-to-Right Override,			Strong	*/ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
	kWRdirR,					/* Right-to-Left, 					Strong	*/
	kWRdirAL,					/* Right-to-Left Arabic,			Strong	*/
	kWRdirRLE,					/* Right-to-Left Embedding,			Strong	*/ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
	kWRdirRLO,					/* Right-to-Left Override,			Strong	*/ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
	kWRdirPDF,					/* Pop Directional Format,			Weak	*/ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
    ...
    /* following are the characters introduced after Unicode 4 */
    kWRdirLRI,                 /* Left-to-Right Isolate,			Explicit Formatting */ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
	kWRdirRLI,                 /* Right-to-Left Isolate,			Explicit Formatting */ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
	kWRdirFSI,                 /* First Strong Isolate,				Explicit Formatting */ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
	kWRdirPDI,                 /* Pop Directional Isolate,			Explicit Formatting */ /*mentioned as "Explicit Formatting" instead of "Strong" in Unicode 14 documentation */
