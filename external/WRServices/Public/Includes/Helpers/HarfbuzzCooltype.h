...
struct hb_ct_font_t
{
	BIB_NAMESPACE::CCTFontDict dict;
	BIB_NAMESPACE::CCTFontInstance font;
	char* lang;
	char* script;
	WRFontDict* wrfontdict;
	WRFontInstance* fFontInstance;
	WRFloat fMatrix;
	BIB_NAMESPACE::CCTEncoding fEncoding;
	BRVRealCoord fDesignVec[kCTMaxDesignElements];
	WRVector<float> fWRDesignVector;
	size_t fDesignVeclength;
	CTTextWritingDirection fCTTextWritingDirection;
};
...
static void _hb_ct_font_set_funcs(hb_font_t *font, BIB_NAMESPACE::CCTFontDict dict, BIB_NAMESPACE::CCTFontInstance fontInstance, char * lang, char * script);
...
public:
	...
	HarfbuzzCooltype() :fOptyca(nullptr) {};
	HarfbuzzCooltype(IWROptyca* optyca) :fOptyca(optyca) {};
...
public:
	...
	virtual hb_font_t *
        hb_ct_font_create(WRFontDict * dict, WRFontInstance * instance, char * lang, char * script, hb_destroy_func_t destroy, hb_face_t * face = NULL);
	//callback functions start
	friend void
		WR_HB_ApplyFeatures(void *font_data, void* clientRunContext, WROTFeatureInfo *featureInfo, WRFloat* endPenPos);
	friend  void
		_hb_ct_font_set_funcs(hb_font_t *font, BIB_NAMESPACE::CCTFontDict dict, BIB_NAMESPACE::CCTFontInstance fontInstance,WRFontInstance * instance);
	friend hb_blob_t *
