...
WRSERVICES_DECL void WRServicesFontsUsed(std::set<std::string> fonts);
...
WRSERVICES_DECL void SetHighbeamInfoWithLibFolder(const char* personGUID, const char* licenseStatus, int state, const char* productName, const char* productVersion, const char* productLocale, const WRPath headlightsLibFolder);
