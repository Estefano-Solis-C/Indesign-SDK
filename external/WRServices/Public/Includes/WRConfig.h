...
/* Unix platform */
#if (defined(__unix__) || defined(unix))  && !defined(__EMSCRIPTEN__) && !defined(SIMULATED_WASM) && !defined(__ANDROID__)
#ifndef WR_UNIX_ENV
#define WR_UNIX_ENV
#endif

/* Web platform */
#if defined(__EMSCRIPTEN__) || defined(SIMULATED_WASM)
#ifndef WR_WEB_ENV
#define WR_WEB_ENV
#endif // WR_WEB_ENV
#endif // defined(__EMSCRIPTEN__) || defined(SIMULATED_WASM)
...
#define ANDROID 1
#ifndef WR_ANDROID_ENV
#define WR_ANDROID_ENV
#endif
...
#if defined(WR_WIN_ENV)
	#define	WR_DLLEXPORT	__declspec(dllexport)
	#define	WR_DLLIMPORT	__declspec(dllimport)
	#define WR_DLLLOCAL
	#define WR_DLLPUBLIC
#elif defined(WR_MAC_ENV)
	#define WR_DLLIMPORT
	#ifdef GCC_HASCLASSVISIBILITY
		#define WR_DLLEXPORT	__attribute__ ((visibility("default")))
		#define WR_DLLLOCAL		__attribute__ ((visibility("hidden")))
		#define WR_DLLPUBLIC	__attribute__ ((visibility("default")))
	#else
		#define WR_DLLEXPORT
		#define WR_DLLLOCAL
		#define WR_DLLPUBLIC
	#endif
#elif defined(AIX_PLATFORM) || defined(HP_PLATFORM) || defined(LINUX_PLATFORM) || defined(SOLARIS_PLATFORM) || defined(ANDROID_ENV) || defined(WR_ANDROID_ENV) || defined(WR_UNIX_ENV) || defined(WR_WEB_ENV)
	#define	WR_DLLIMPORT	
        #ifdef GCC_HASCLASSVISIBILITY
           #define WR_DLLEXPORT  __attribute__ ((visibility("default")))
           #define WR_DLLLOCAL   __attribute__ ((visibility("hidden")))
