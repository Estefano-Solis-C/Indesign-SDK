...
public:
	...
	virtual void Clear() = 0; //WRServices-695 : Added for clearing cached CCTFontInstances
	virtual void Open() = 0;
	virtual void Close() = 0;
	virtual void Invalidate() = 0;
	virtual void RemoveFont(WRFontDict* dict, WRVector<WRFloat> designVector = WRVector<WRFloat>())=0;
	virtual WRReadWriteLock* getLock() = 0;
};
