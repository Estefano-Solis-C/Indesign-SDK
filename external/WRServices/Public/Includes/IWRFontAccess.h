...
public:
	...
	**/
    ...
    virtual WRGlyphID32 WRCFFGlyphIDToCTGlyphID(WRFontDict * aFont, WRGlyphID32 cffID) = 0;
	...
	**/
    ...
    virtual void            WRGetGlyphEmBox( WRFontInstance *inst,WRFloatRect* bbox )=0;
	virtual void			WRGetGlyphBBox( WRFontInstance *inst, WRInt32 glyphID, WRFloatRect* bbox ) = 0;
	virtual void			WRGetICFBox( WRFontDict*, WRFloatRect *icfBox,  WRFloat* mmDesignVector = NULL, int designVectorLength = 0); // implement it as CTGetVal(icfbox), never called if GetCharacterRotation always return 0
	...
	virtual WRBool			WRGetNthOTVDesignAxisName(WRFontDict *aFont, int index, char* buffer) = 0;
